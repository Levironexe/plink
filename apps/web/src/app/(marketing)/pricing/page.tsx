  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-5xl px-6 pt-28">
        <Reveal>
          <h2 className="text-center text-[clamp(1.7rem,3.4vw,2.4rem)] font-semibold text-ink">
        ...
        <Reveal delay={80}>
          <div className="mt-10 overflow-x-auto">
            <table className="w-full min-w-[640px] border-separate border-spacing-0">
              <thead>
                <tr>
                  <th className="w-2/5 pb-4 text-left font-mono text-[12px] leading-4 text-ink-muted">
                    Feature
                  </th>
                  {["Free", "Pro", "Studio"].map((p) => (
                    <th key={p} className="pb-4 text-center text-[15px] font-semibold text-ink">
                      {p}
                    </th>
                  ))}
                </tr>
      ...
      <section className="mx-auto max-w-6xl px-6 pt-28" id="faq">
