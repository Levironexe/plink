...
import { cn, compactNumber, hostOf } from "@plink/core/utils";
    ...
    >
      <div className="flex items-center gap-2 p-3">
        <button
          ...
          className="shrink-0 cursor-grab touch-none rounded-lg p-1.5 text-ink-muted transition hover:bg-canvas-deep hover:text-ink active:cursor-grabbing"
        >
        ...
        <button
          ...
          className="shrink-0 rounded-lg p-2 text-ink-muted transition hover:bg-canvas-deep hover:text-ink"
        >
      ...
      {expanded && (
        <div className="border-t border-line px-4 pt-4 pb-4">
          ...
          <BlockSchedule block={block} onChange={onChange} />
          <div className="mt-5 flex items-center justify-between gap-2 border-t border-line pt-4">
            <button
              onClick={onDuplicate}
              className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[13.5px] font-semibold text-ink-muted transition hover:bg-canvas-deep hover:text-ink"
            >
              <Copy className="size-4" /> Duplicate
            </button>
            <button
              onClick={onDelete}
              className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[13.5px] font-semibold text-danger transition hover:bg-danger/10"
            >
