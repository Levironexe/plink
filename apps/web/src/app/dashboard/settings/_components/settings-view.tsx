  ...
  return (
    <div className="mx-auto max-w-[900px] px-4 py-6 sm:px-6 lg:py-10">
      ...
      <div className="mt-8 flex flex-col gap-5">
        ...
        <QrPanel username={initialUsername} pageUrl={`https://plink.to/${initialUsername}`} />

        <DomainPanel
          username={initialUsername}
          domain={domain}
          verifiedAt={domainVerifiedAt}
          plan={plan}
        />
            ...
            {PLANS.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 text-[20px] font-semibold text-ink">
                    ${p.monthly}
...
function Panel({
  ...
  return (
    <section
      className={cn(
        "rounded-xl border p-5 shadow-soft sm:p-6",
        tone === "danger" ? "border-danger/35 bg-[#fffaf9]" : "border-line bg-surface",
      )}
    >
