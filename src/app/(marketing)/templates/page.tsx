        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {DEMO_PROFILES.map((profile, i) => (
            <Reveal key={profile.id} delay={i * 60}>
              <article className="group overflow-hidden rounded-[26px] border border-line bg-surface shadow-soft transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lift">
