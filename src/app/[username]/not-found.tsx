...
export default function ProfileNotFound() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-5 text-center">
      <Logo />
      <p className="mt-10 font-display text-[80px] leading-none font-extrabold text-brand-200">404</p>
      <h1 className="mt-2 text-[28px] font-extrabold text-ink">This Plink doesn’t exist yet</h1>
