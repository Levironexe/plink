...
import { THEME_PRESETS, presetToTheme } from "@/lib/themes";
import { SOCIAL_PLATFORMS, socialPlatform } from "@/lib/socials";
    ...
    <div className="grid min-h-dvh lg:grid-cols-[minmax(0,1fr)_420px]">
      <div className="flex flex-col px-5 py-6 sm:px-10">
        ...
        <div className="mx-auto flex w-full max-w-[520px] flex-1 flex-col justify-center py-10">
          ...
          <div className="mt-10">
            {step === 0 && (
              <section>
                <h1 className="text-[30px] leading-tight font-extrabold text-ink">Tell us who you are</h1>
            ...
            {step === 1 && (
              <section>
                <h1 className="text-[30px] leading-tight font-extrabold text-ink">Add your first links</h1>
            ...
            {step === 2 && (
              <section>
                <h1 className="text-[30px] leading-tight font-extrabold text-ink">Where else are you?</h1>
            ...
            {step === 3 && (
              <section>
                <h1 className="text-[30px] leading-tight font-extrabold text-ink">Pick a look</h1>
      ...
      <aside className="relative hidden items-center justify-center bg-ink lg:flex">
        <div aria-hidden className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -right-20 bottom-0 size-[360px] rounded-full bg-coral/20 blur-[120px]" />
        </div>
