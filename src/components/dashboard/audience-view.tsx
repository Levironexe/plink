    ...
    <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6 lg:py-10">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-3">
        <div className="rounded-[24px] border border-line bg-surface p-5 shadow-soft">
          <p className="text-[13px] font-bold tracking-wider text-ink-muted uppercase">Subscribers</p>
          <p className="mt-2 text-[30px] leading-none font-extrabold text-ink">{subscribers.length}</p>
          {plan === "free" && (
            <>
        ...
        <div className="rounded-[24px] border border-line bg-surface p-5 shadow-soft sm:col-span-2">
          <p className="text-[13px] font-bold tracking-wider text-ink-muted uppercase">New sign-ups</p>
      ...
      {subscribers.length === 0 ? (
        ...
        <section className="mt-8 overflow-hidden rounded-[24px] border border-line bg-surface shadow-soft">
