...
import { DEFAULT_DELIVERABLES, type MediaKitShape } from "@/lib/media-kit";
            ...
            {kit.rateCard.map((item, i) => (
              <div key={i} className="flex items-end gap-2 rounded-2xl border border-line bg-canvas p-3">
                ...
                <button
                  ...
                  className="mb-1 rounded-lg p-2 text-ink-muted transition hover:bg-black/5 hover:text-coral"
                >
