...
import type { EditorBlock, EditorData, EditorProfile } from "./types";
import type { PublicProfile, PublicSocial } from "@/components/profile/types";
import { useDebouncedSave } from "@/lib/hooks";
import {
  addSocial, createBlock, deleteBlock, deleteSocial, duplicateBlock,
  reorderBlocks, updateBlock, updateProfile,
} from "@/app/dashboard/actions";
import type { BlockDefinition } from "@/lib/blocks";

export function PageEditor({ initial }: { initial: EditorData }) {
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-[20px] border-2 border-dashed border-line-strong py-5 text-[15px] font-semibold text-ink-muted transition hover:border-ink hover:text-ink"
          >
