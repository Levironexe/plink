...
import type { PublicSocial } from "@/components/profile/types";
...
export function ProfileEditor({
  ...
  return (
    <section className="rounded-[24px] border border-line bg-surface shadow-soft">
      <button
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        ...
        <div className="border-t border-line p-4">
          ...
          <div className="mt-4">
            <TextField
              ...
              onChange={(e) => onProfileChange({ bannerUrl: e.target.value })}
...
function SocialsEditor({
  ...
  return (
    <div className="mt-6 border-t border-line pt-5">
      <p className="text-[13px] font-bold tracking-wider text-ink-muted uppercase">Social icons</p>
              ...
              <li key={s.id}>
                <span className="inline-flex items-center gap-2 rounded-full border border-line bg-canvas py-1.5 pr-1.5 pl-3 text-[13.5px] font-semibold text-ink">
                  ...
                  <button
                    ...
                    className="grid size-6 place-items-center rounded-full text-ink-muted transition hover:bg-black/10 hover:text-coral"
                  >
                    ×
                  </button>
                </span>
