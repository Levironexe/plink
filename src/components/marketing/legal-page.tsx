export function LegalPage({
  ...
  return (
    <article className="mx-auto max-w-3xl px-5 pt-16 pb-28 sm:pt-24">
      <p className="text-[13px] font-bold tracking-wider text-brand-600 uppercase">Legal</p>
      <h1 className="mt-3 text-[clamp(2.2rem,5vw,3rem)] leading-tight font-extrabold text-ink">{title}</h1>
